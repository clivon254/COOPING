...
export default function AddLiqour() {
    ...
    const handleSubmit = async (e) => {
        ...
        try
        {
            ...
            const res = await axios.post(url + "/api/product/create-liqour",formData,{headers:{token}})

            if(res.data.success)
            {
                setFormData()

                navigate(`/product/${res.data.liquor._id}`)

                toast.success(`${res.data.liquor.name} is added successfully `)
  ...
  return (
    ...
    <section className="w-full p-5 space-y-10">
        ...
        <h2 className="text-center text-4xl/9 font-bold">Add Liqour</h2>
