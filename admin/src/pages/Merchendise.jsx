      ...
      <section className="w-full p-5 space-y-10">
        ...
        <div className="flex flex-col gap-y-3 sm:flex-row sm:justify-between sm:items-center">
          ...
          <div className="space-y-1">
            ...
            <h2 className="text-4xl 2xl:text-5xl font-bold font-title">Merchendise</h2>

            <h4 className="text-xs md:text-sm 2xl:text-xl text-slate-600">Detailed information about the merchendise we offer</h4>
