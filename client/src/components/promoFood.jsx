            ...
            <div>
              ...
              <div className="mt-10">
                      ...
                      <div className="grid shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                        ...
                        <div className="h-64 w-44 overflow-hidden rounded-lg sm:opacity-0 lg:opacity-100">
                          ...
                          <img
                            ...
                            className="size-full object-cover shadow shadow-amber-100"
                          />
                ...
                <Link to="/">
                    ...
                    <button 
                        className="inline-block rounded-md border border-transparent bg-[#FF9900] px-8 py-3 text-center font-medium text-white shadow-md"
                    >
                        Shop Collection
                    </button>
