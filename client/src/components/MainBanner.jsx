...
import { Pizza , Package,Soup,CupSoda,Martini,Shirt} from 'lucide-react';
...
export default function(){
  ...
  const icons = [
    { component: Soup, name: "Food" ,link:"/food" },
    { component: Martini, name: "Booze" ,link:"/liqour"},
    { component: CupSoda, name: "Drinks" ,link:"/drink"},
    { component: Package, name: "Anything" ,link:"/"},
    { component: Shirt, name: "Merch" ,link:"/merchendise"},
    { component: Pizza, name: "Takeaway" ,link:"/"}
  ];
  ...
  const getIconPosition = (index) => {
    ...
    return { x, y, angle: ((index * (360 / icons.length)) + rotation) % 360 };
  };
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2 text-white mb-8 md:mb-0 text-center md:text-left">
              ...
              <h1 className="text-4xl font-bold mb-4">Need Anything? We've got you covered!</h1>
