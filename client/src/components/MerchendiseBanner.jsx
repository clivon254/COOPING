...
export default function MerchendiseBanner() {
  ...
  return (
    ...
    >
        ...
        <div className="h-full w-full flex flex-col items-center justify-center p-4 gap-y-5 bg-black/50">
            ...
            <p className="md:text-center font-bold sm:font-semibold text-3xl sm:text-4xl lg:text-5xl tracking-wide text-white max-w-4xl capitalize">
